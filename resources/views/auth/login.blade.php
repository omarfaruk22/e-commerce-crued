...
<div class="d-flex align-items-center justify-content-center ht-100v">
      ...
      <div class="overlay-body bg-black-7 d-flex align-items-center justify-content-center">
       ...
       <div     class = "mt-4 form-group">
        ...
        <input id = "email"  class = "form-control fc-outline-dark " placeholder = "Enter your email" type = "text" name = "email" :value = "old('email')" required autofocus />
    </div>
        ...
        <div     class = "form-group">
         <x-label for   = "password" :value = "__('Password')" />
          ...
          <input id           = "password" class = "form-control fc-outline-dark"
                 type         = "password"
                 name         = "password"
